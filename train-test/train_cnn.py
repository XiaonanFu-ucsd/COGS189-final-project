...
def train(
    ...
    epochs = min(200, int(6000000/trainloader.dataset.tensors[0].shape[0]))       # Total epochs.
    print('Total epochs: {}'.format(epochs))
    print_freq = 400  # Print frequency.
    ...
    # save report
    report = "tn, fp, fn, tp: " + "  ".join([str(i) for i in confusion_matrix(y_gt, y_pred).ravel().tolist()]) + "\n"
    report += "f1 score: " + f1_score(y_gt, y_pred).astype(str) + "\n"
    report += "accuracy: " + str(correct/total) + "\n"
