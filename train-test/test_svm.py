...
def load_model(model_path):
    if model_path is None:
        ...
        clf = SVC(C=0.1, kernel='linear', class_weight=class_weight)
        return clf
...
def train_and_test(
    ...
    # downsample
    num_points = 8; # we will divide our window into num_points means
